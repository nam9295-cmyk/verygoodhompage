...
test('public category pages show only the curated releases with their final category names', async () => {
  ...
  assert.match(chocolate, /Eiffel Tower Chocolate/)
  assert.match(chocolate, /Pave Chocolate/)
  ...
  assert.match(chocolate, /au-product-card__placeholder[^>]*><span>Pave Chocolate<\/span><small>Image coming soon<\/small>/)
  assert.match(chocolate, /au-product-card__placeholder[^>]*><span>S&#x27;mores Stick<\/span><small>Image coming soon<\/small>/)
