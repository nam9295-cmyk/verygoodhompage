...
export const AU_PUBLIC_PRODUCT_IDS = Object.freeze({
  ...
  goods: Object.freeze(['gift-2-set', 'gift-4-set', 'hogeori-keyring', 'horse-keyring']),
})
...
export const AU_PRODUCTS = Object.freeze([
  ...
  },
  {
    ...
    media: {
      card: '/assets/au/chocolate/almond-chocolate/almond.png',
      hero: '/assets/au/chocolate/almond-chocolate/almond_pop.webp',
      gallery: [],
      altEn: 'Almond Chocoball packaging.',
      altKo: '아몬드 초코볼 패키지.',
    },
    detail: {
      legacyProductId: 'almond-chocoball',
      flavorProfile: [
        { label: 'Crunchiness', labelKo: '바삭함', value: 95 },
        { label: 'Nutty', labelKo: '고소함', value: 85 },
        { label: 'Bitterness', labelKo: '쌉쌀함', value: 70 },
        { label: 'Sweetness', labelKo: '달콤함', value: 60 },
        { label: 'Aftertaste', labelKo: '여운', value: 70 },
      ],
      featureIcons: [
        { icon: '/assets/au/chocolate/almond-chocolate/almond_icon1.svg', label: 'Roasting', labelKo: '로스팅' },
        { icon: '/assets/au/chocolate/almond-chocolate/almond_icon2.svg', label: 'High Cacao', labelKo: '높은 카카오 함량' },
        { icon: '/assets/au/chocolate/almond-chocolate/almond_icon4.svg', label: 'Crunchy', labelKo: '바삭한 식감' },
      ],
    },
  },
  {
    ...
    media: {
      card: '/assets/au/chocolate/strawberry-bonbon/straw.png',
      hero: '/assets/au/chocolate/strawberry-bonbon/bonbon_pop.webp',
      gallery: [],
      altEn: 'Strawberry Bonbon packaging.',
      altKo: '스트로베리 봉봉 패키지.',
    },
    detail: {
      legacyProductId: 'strawberry-bonbon',
      flavorProfile: [
        { label: 'Real Strawberry', labelKo: '실제 딸기', value: 95 },
        { label: 'Crunchy', labelKo: '바삭한 식감', value: 90 },
        { label: 'Sweetness', labelKo: '달콤함', value: 85 },
        { label: 'Creamy', labelKo: '크리미함', value: 80 },
        { label: 'Sourness', labelKo: '산미', value: 70 },
      ],
      featureIcons: [
        { icon: '/assets/au/chocolate/strawberry-bonbon/bonbon_icon1.svg', label: 'Freeze-Dried', labelKo: '동결 건조' },
        { icon: '/assets/au/chocolate/strawberry-bonbon/bonbon_icon2.svg', label: 'Real Fruit Inside', labelKo: '실제 과일' },
        { icon: '/assets/au/chocolate/strawberry-bonbon/bonbon_icon3.svg', label: 'Creamy White Chocolate', labelKo: '크리미한 화이트 초콜릿' },
        { icon: '/assets/au/chocolate/strawberry-bonbon/bonbon_icon4.svg', label: 'Crunchy Texture', labelKo: '바삭한 식감' },
      ],
    },
  },
  {
    ...
    copy: {
      en: {
        ...
        shortDescription: 'Eiffel Tower Chocolate in Verygood gift packaging.',
        story: 'A Verygood Chocolate piece presented in gift packaging.',
      },
      ko: {
        name: '에펠 초콜릿',
        shortDescription: '베리굿 기프트 패키지에 담긴 에펠 타워 초콜릿.',
        story: '베리굿 기프트 패키지로 소개하는 초콜릿 피스입니다.',
      },
    },
    media: {
    ...
    detail: { legacyProductId: 'eiffel-chocolate' },
  },
  {
  ...
  },
  {
    ...
    media: {
      card: '/assets/au/tea/british-black/british_cup.webp',
      hero: '/assets/au/tea/british-black/british_pop.webp',
      gallery: [
        '/assets/au/tea/british-black/gallery/british_th1.webp',
        '/assets/au/tea/british-black/gallery/british_th2.webp',
        '/assets/au/tea/british-black/gallery/british_th3.webp',
        '/assets/au/tea/british-black/gallery/british_th4.webp',
      ],
      altEn: 'British Black tea in a glass cup.',
      altKo: '유리 찻잔에 담긴 브리티시 블랙.',
    },
    detailSections: [
      { label: 'Blend story', labelKo: '블렌드 이야기', body: 'A dark, fragrant blend with cacao nib depth and the familiar lift of Earl Grey.', bodyKo: '카카오 닙의 깊이와 익숙한 얼그레이 향을 담은 진하고 향긋한 블렌드입니다.' },
      { label: 'Aroma', labelKo: '향', body: 'Cacao nib, Earl Grey and cornflower.', bodyKo: '카카오 닙, 얼그레이, 콘플라워.' },
      { label: 'Flavour', labelKo: '맛', body: 'Deep, aromatic and softly sweet.', bodyKo: '깊고 향긋하며 은은하게 달콤합니다.' },
      { label: 'Tea base', labelKo: '티 베이스', body: 'Earl Grey.', bodyKo: '얼그레이.' },
      { label: 'Ingredients', labelKo: '재료', body: 'Cacao nib, Earl Grey and cornflower.', bodyKo: '카카오 닙, 얼그레이, 콘플라워.' },
    ],
    detail: { legacyProductId: 'british-black' },
  },
  {
    id: 'asian-gold',
    category: 'tea',
    ...
    media: {
      card: '/assets/au/tea/asian-gold/asian_cup.webp',
      hero: '/assets/au/tea/asian-gold/asian_pop.webp',
      gallery: [
        '/assets/au/tea/asian-gold/gallery/asian_th1.webp',
        '/assets/au/tea/asian-gold/gallery/asian_th2.webp',
        '/assets/au/tea/asian-gold/gallery/asian_th3.webp',
        '/assets/au/tea/asian-gold/gallery/asian_th4.webp',
      ],
      altEn: 'Asian Gold tea in a glass cup.',
      altKo: '유리 찻잔에 담긴 아시안 골드.',
    },
    detailSections: [
      { label: 'Blend story', labelKo: '블렌드 이야기', body: 'A gentle oolong blend with a rounded texture and floral lift.', bodyKo: '둥근 질감과 꽃향의 인상을 담은 부드러운 우롱 블렌드입니다.' },
      { label: 'Aroma', labelKo: '향', body: 'Soft floral notes.', bodyKo: '은은한 꽃향.' },
      { label: 'Flavour', labelKo: '맛', body: 'A smooth, floral finish.', bodyKo: '부드럽고 꽃향이 감도는 마무리.' },
      { label: 'Tea base', labelKo: '티 베이스', body: 'Golden Oolong tea.', bodyKo: '골든 우롱 티.' },
      { label: 'Ingredients', labelKo: '재료', body: 'Golden Oolong tea.', bodyKo: '골든 우롱 티.' },
    ],
    detail: { legacyProductId: 'asian-gold' },
  },
  {
    id: 'hibiscus-fruit',
    category: 'tea',
    ...
    media: {
      card: '/assets/au/tea/hibiscus-fruit/hibis_cup.webp',
      hero: '/assets/au/tea/hibiscus-fruit/hibis_pop.webp',
      gallery: [
        '/assets/au/tea/hibiscus-fruit/gallery/hibis_th1.webp',
        '/assets/au/tea/hibiscus-fruit/gallery/hibis_th2.webp',
        '/assets/au/tea/hibiscus-fruit/gallery/hibis_th3.webp',
        '/assets/au/tea/hibiscus-fruit/gallery/hibis_th4.webp',
      ],
      altEn: 'Hibiscus Fruit tea in a glass cup.',
      altKo: '유리 찻잔에 담긴 히비스커스 프루트.',
    },
    detailSections: [
      { label: 'Blend story', labelKo: '블렌드 이야기', body: 'A vivid fruit blend with hibiscus at its centre.', bodyKo: '히비스커스를 중심으로 과일의 인상을 담은 선명한 블렌드입니다.' },
      { label: 'Aroma', labelKo: '향', body: 'Hibiscus and tropical fruit.', bodyKo: '히비스커스와 열대 과일.' },
      { label: 'Flavour', labelKo: '맛', body: 'A bright, tangy cup.', bodyKo: '밝고 상큼한 한 잔.' },
      { label: 'Ingredients', labelKo: '재료', body: 'Hibiscus and tropical fruit.', bodyKo: '히비스커스와 열대 과일.' },
    ],
    detail: { legacyProductId: 'hibiscus-fruit' },
  },
  {
    id: 'minty-chocolat',
    category: 'tea',
    ...
    media: {
      card: '/assets/au/tea/minty-chocolat/minty_cup.webp',
      hero: '/assets/au/tea/minty-chocolat/minty_pop.webp',
      gallery: [
        '/assets/au/tea/minty-chocolat/gallery/minty_th1.webp',
        '/assets/au/tea/minty-chocolat/gallery/minty_th2.webp',
        '/assets/au/tea/minty-chocolat/gallery/minty_th3.webp',
        '/assets/au/tea/minty-chocolat/gallery/minty_th4.webp',
      ],
      altEn: 'Minty Chocolat tea in a glass cup.',
      altKo: '유리 찻잔에 담긴 민티 쇼콜라.',
    },
    detailSections: [
      { label: 'Blend story', labelKo: '블렌드 이야기', body: 'A fresh mint-led blend with cacao nibs for a soft chocolate note.', bodyKo: '민트의 산뜻함에 카카오 닙의 부드러운 초콜릿 인상을 더한 블렌드입니다.' },
      { label: 'Aroma', labelKo: '향', body: 'Mint tea and cacao nib.', bodyKo: '민트 티와 카카오 닙.' },
      { label: 'Flavour', labelKo: '맛', body: 'A cool, chocolatey finish.', bodyKo: '시원하고 초콜릿 같은 마무리.' },
      { label: 'Tea base', labelKo: '티 베이스', body: 'Mint tea.', bodyKo: '민트 티.' },
      { label: 'Ingredients', labelKo: '재료', body: 'Mint tea and cacao nib.', bodyKo: '민트 티와 카카오 닙.' },
    ],
    detail: { legacyProductId: 'minty-chocolat' },
  },
  {
    id: 'gift-2-set',
    category: 'goods',
    ...
    copy: {
      en: {
        name: 'Gift 2 Set',
        shortDescription: 'A curated set of two chocolates in our signature triangular box.',
        story: 'Part of the existing Verygood goods collection.',
        detailsLabel: 'Collection',
        details: 'Two chocolates in a signature triangular box.',
      },
      ko: {
        name: '기프트 2 세트',
        shortDescription: '시그니처 삼각 박스에 담은 두 가지 초콜릿 세트.',
        story: '기존 베리굿 굿즈 컬렉션의 한 구성입니다.',
        detailsLabel: '구성',
        details: '시그니처 삼각 박스에 담은 두 가지 초콜릿.',
      },
    },
    media: {
      card: '/assets/au/goods/gift-2-set.png',
      hero: '/assets/au/goods/gift-2-set.png',
      gallery: [],
      altEn: 'Verygood Chocolate Gift 2 Set.',
      altKo: '베리굿 초콜릿 기프트 2 세트.',
    },
    detail: { legacyProductId: 'gift-2-set' },
  },
  {
    id: 'gift-4-set',
    category: 'goods',
    ...
    copy: {
      en: {
        name: 'Gift 4 Set',
        shortDescription: 'A collection of four Verygood Chocolate varieties in a gift package.',
        story: 'Part of the existing Verygood goods collection.',
        detailsLabel: 'Collection',
        details: 'Four Verygood Chocolate varieties in a gift package.',
      },
      ko: {
        name: '기프트 4 세트',
        shortDescription: '기프트 패키지에 담은 베리굿 초콜릿 네 가지 구성.',
        story: '기존 베리굿 굿즈 컬렉션의 한 구성입니다.',
        detailsLabel: '구성',
        details: '기프트 패키지에 담은 베리굿 초콜릿 네 가지 구성.',
      },
    },
    media: {
      card: '/assets/au/goods/gift-4-set.png',
      hero: '/assets/au/goods/gift-4-set.png',
      gallery: [],
      altEn: 'Verygood Chocolate Gift 4 Set.',
      altKo: '베리굿 초콜릿 기프트 4 세트.',
    },
    detail: { legacyProductId: 'gift-4-set' },
  },
  {
    id: 'hogeori-keyring',
    category: 'goods',
    ...
    media: {
      card: '/assets/au/goods/hogeori-keyring.png',
      hero: '/assets/au/goods/hogeori-keyring.png',
      gallery: [],
      altEn: 'Hogeori character keyring.',
      altKo: '호걸이 캐릭터 키링.',
    },
    detail: { legacyProductId: 'hogirl-key-ring' },
  },
  {
    id: 'horse-keyring',
    category: 'goods',
    ...
    copy: {
      en: {
        name: 'Horse Keyring',
        shortDescription: 'A horse character keyring for a bag or keys.',
        story: 'Part of the existing Verygood goods collection.',
        detailsLabel: 'About this item',
        details: 'Horse character keyring.',
      },
      ko: {
        name: '말 키링',
        shortDescription: '가방이나 열쇠에 함께할 말 캐릭터 키링.',
        story: '기존 베리굿 굿즈 컬렉션의 한 구성입니다.',
        detailsLabel: '아이템 소개',
        details: '말 캐릭터 키링.',
      },
    ...
    media: {
      card: '/assets/au/goods/horse-keyring.png',
      hero: '/assets/au/goods/horse-keyring.png',
      gallery: [],
      altEn: 'Horse character keyring.',
      altKo: '말 캐릭터 키링.',
    },
    detail: { legacyProductId: 'horse-key-ring' },
  },
  {
    id: 'buttercream-cake',
    category: 'cakes',
  ...
  },
  {
    ...
    action: catalogueOnly,
    copy: {
      en: { name: 'Pave Chocolate', shortDescription: 'Pave Chocolate from the Verygood Chocolate collection.', story: '' },
      ko: { name: '파베 초콜릿', shortDescription: '베리굿 초콜릿 컬렉션의 파베 초콜릿.', story: '' },
    },
    media: placeholderProductImage,
    detail: { legacyProductId: 'pave-chocolate' },
  },
  {
    ...
    action: catalogueOnly,
    copy: {
      en: { name: "S'mores Stick", shortDescription: "S'mores Stick from the Verygood Chocolate collection.", story: '' },
      ko: { name: '스모어 스틱', shortDescription: '베리굿 초콜릿 컬렉션의 스모어 스틱.', story: '' },
    },
    media: placeholderProductImage,
    detail: { legacyProductId: 'marshmallow-smores-stick' },
  },
  {
    id: 'hogeori-plush',
    category: 'goods',
...
export const AU_LEGACY_PRODUCT_TARGETS = Object.freeze(
  Object.fromEntries(
    AU_PRODUCTS
      .filter((product) => product.status === 'published' && product.detail?.legacyProductId)
      .map((product) => [product.detail.legacyProductId, [product.category, product.slug]]),
  ),
)
