    ...
    coreExperiences: [
      {
        ...
        products: [
          ...
          { id: 'whole-cake', name: 'Whole Cake', options: ['Vanilla Fresh Cream', 'Chocolate Buttercream', '3 Sizes'], ctaLabel: 'View & Book', href: AU_BOOKING_PRODUCT_LINKS.vanillaFreshCreamCake, image: { src: '/assets/booking/vanilla-cake-sydney.webp', alt: 'Vanilla Fresh Cream Cake.', placeholderLabel: 'Image coming soon' } },
    ...
    coreExperiences: [
      {
        ...
        products: [
          ...
          { id: 'whole-cake', name: '홀 케이크', options: ['바닐라 생크림', '초콜릿 버터크림', '3가지 사이즈'], ctaLabel: '예약 보기', href: AU_BOOKING_PRODUCT_LINKS.vanillaFreshCreamCake, image: { src: '/assets/booking/vanilla-cake-sydney.webp', alt: '바닐라 생크림 케이크.', placeholderLabel: '이미지 준비 중' } },
      ...
      },
      {
        ...
        products: [
          { id: 'lemon', name: '레몬 케이크', options: ['4개', '6개', '12개', '16개'], ctaLabel: '예약 보기', href: AU_BOOKING_PRODUCT_LINKS.lemonCake, image: { src: '/assets/booking/lemon-cake-sydney.webp', alt: '레몬 케이크.', placeholderLabel: '이미지 준비 중' } },
