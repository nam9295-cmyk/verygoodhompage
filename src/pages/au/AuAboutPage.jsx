...
const content = {
  en: {
    ...
    sydney: 'In Sydney, our public offering focuses on made-to-order cakes and bakes, pre-arranged Melrose Park pickup, and private kids cake classes with Jenny.',
    cakes: 'Explore Cakes',
  ...
  ko: {
    ...
    sydney: '시드니에서는 주문 제작 케이크와 베이크, 사전 조율된 멜로즈 파크 픽업, Jenny와 함께하는 프라이빗 키즈 케이크 클래스를 중심으로 만납니다.',
    cakes: '케이크 보기',
    korea: '한국 사이트 방문',
  },
}
